...
import 'package:admin/view/screen/orders/dialograting.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:jiffy/jiffy.dart';
import '../../../core/constant/routes.dart';

class CardOrderListAchive extends GetView<OrdersArchiveController> {
  final OrderModel listdata;
  const CardOrderListAchive({Key? key, required this.listdata}) : super(key: key);
          ...
          children:  [
            ...
            Row(
                children: [
                  ...
                  color: AppColor.thirdColor,textColor: AppColor.secoundColor,child:const Text("Details"),),
                  const SizedBox(width: 10),
                  if(listdata.ordersRating == "0") MaterialButton(
                    onPressed: (){
                     showDialogRating(context,listdata.ordersId!);
                    },
                    color: AppColor.thirdColor,textColor: AppColor.secoundColor,child:const Text("Rating"),),
                ]
            )
          ],
        ),
